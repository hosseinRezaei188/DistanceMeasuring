...
namespace Distance_Measuring.Controllers
{
    ...
    public class DistanceMeasureController : ControllerBase
    {
        ...
        [HttpPost("Measure")]
        public async Task<Response> Measure(Model.Location location1, Model.Location location2)
        {

            return await distanceMeasureDataProvider.MeasureDistance(location1, location2);
        }
    }

...
namespace Distance_Measuring.DataProvider
{
    public class UserDataProvider : IDataProvider.IUserDataProvider
    {
        ...
        public async Task<UserResponse> Register(UserViewModel userViewModel)
        {
        ...
        public async Task<UserResponse> Login(UserViewModel userViewModel)
        {
        ...
        async Task<User> GetUserIfExist(string userName)
        {
            //check if user is exist with this username

...
namespace Distance_Measuring.DataProvider
{
    public class UserDataProvider : IDataProvider.IUserDataProvider
    {
        ...
        public async Task<object> Register(UserViewModel userViewModel)
        {
            ...
            try
            {
                ...
                if (!CheckUserExist(userViewModel.UserName))
                {
                    ...
                    var tokenDescriptor = new SecurityTokenDescriptor
                    {
                        ...
                        {
                    new Claim(ClaimTypes.Name, userViewModel.UserName.ToString())
                        }),
                    ...
                    result = new UserResponse { Message = "Ok", Code = StatusCodes.Status200OK, UserName = userViewModel.UserName, Token = tokenString };
            ...
            {
                result = new UserResponse { Message = ex.Message,
        ...
        public Task<bool> CheckUserExist(UserViewModel userViewModel)
        {
            throw new NotImplementedException();
        }
